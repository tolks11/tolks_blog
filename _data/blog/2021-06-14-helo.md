...
* Blockchains ability to uniquely enable coordination and incentive alignment
* Composability & Interoperability 
* NFTs (non-fungible tokens) and the ability to apply ownership and value to digital items
* Rapid flywheel, feedback loops, and network effects
* Current disruption and product market fit
* Holistic industry analysis & flows 
...
This description also illuminates another positive externality of the crypto industry which that it is often times a true meritocracy.  There are certainly Venture Capital exclusive raises and early funding which is natural in a system that requires capital influx for growth in it's earliest stages, but overwhelmingly if you can add value to a protocol you will be valued inside said protocol again without geographic, race, religion, or gender restrictions.
...
Simply put, NFTs (non-fungible tokens) are interoperable, programmable, verifiable representations of digital objects.  This obviously lends itself to a design space that is virtually unlimited.  
...
Increasingly, I think the growth of crypto and adoption will be seen through some blockchain game that leverages NFTs to allow users ownership and participation in a robust, thriving digital economies like Axie Infinity along with vast potential games such as Star Atlas and other blockchain based games (read more on Axie and disruption [here](https://tolks.me/disruption) along with the intersection of NFTs and gaming [here](https://tolks.me/NFTS)).

For more, you can check out my in-depth breakdown of NFTs and what they allow [here](https://tolks.me/NFTS)
